...
perf stat -r 5 -a -e power/energy-cores/,power/energy-pkg/,power/energy-ram/ ~/proyecto2PARALELO/release/img-soa ~/proyecto2PARALELO/in ~/proyecto2PARALELO/out mono > /dev/null
echo "2 threads"
